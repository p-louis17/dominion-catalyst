  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0">
        <div className="absolute top-20 left-10 w-72 h-72 bg-brand-green/10 rounded-full blur-3xl animate-pulse"></div>
        <div className="absolute bottom-20 right-10 w-96 h-96 bg-brand-green/5 rounded-full blur-3xl animate-pulse delay-1000"></div>
      </div>

      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center max-w-4xl mx-auto">
          {/* Badge */}
          <div className="inline-flex items-center space-x-2 bg-brand-green/20 border border-brand-green/30 rounded-full px-4 py-2 mb-8 consulting-fade-in">
            <Star className="w-4 h-4 text-brand-green" />
            <span className="text-brand-green text-sm font-medium">Rwanda's Premier Consulting Partner</span>
          </div>
          ...
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold mb-6 consulting-fade-in stagger-animation" style={{"--delay": "200ms"} as React.CSSProperties}>
            ...
            <br />
            <span className="text-brand-green">Business Success</span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center consulting-fade-in stagger-animation" style={{"--delay": "600ms"} as React.CSSProperties}>
            <Button 
              size="lg" 
              className="bg-brand-green hover:bg-brand-green-light text-brand-green-foreground font-semibold px-8 py-4 text-lg green-glow"
            >
            ...
            <Button 
              variant="outline" 
              size="lg" 
              className="border-brand-green/30 text-brand-green hover:bg-brand-green/10 px-8 py-4 text-lg"
            >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-16 consulting-fade-in stagger-animation" style={{"--delay": "800ms"} as React.CSSProperties}>
            <div className="text-center">
              <div className="text-3xl md:text-4xl font-bold text-brand-green mb-2">50+</div>
      ...
      <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2">
        <div className="w-6 h-10 border-2 border-brand-green/50 rounded-full flex justify-center">
          <div className="w-1 h-3 bg-brand-green rounded-full mt-2 animate-bounce"></div>
        </div>
      </div>
    </section>
  );
